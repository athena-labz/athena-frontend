...
const accusation_data = {
    "accusations": [
        {
            id:1,
            "type": "constant",
            "badge_color":"green",
            "publisher": "1a1df04cb621d39dbeb7274ec7795a34708ff4d25a01a1df04c1f27",
        ...
        },
        {
            ...
            "type": "one-time",
            "badge_color":"red",
            "publisher": "374ec7795acf39e7dce03c839994ffdec2ec6b04f1cf2d40e61a3",
...
export function accusations(){
  return accusation_data 
}


export function accusation(id:number){
  return accusation_data.accusations.filter(accusation => accusation.id === id) 
}
